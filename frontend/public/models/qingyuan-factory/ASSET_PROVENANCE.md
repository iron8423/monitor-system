...
本目录的 `qingyuan-factory.glb` 是「真实地形演示资产」：几何骨架来自公开 DEM，
...
- 演示锚点：23.69400N 113.07800E（清远市区以北约 4km 的模拟选址，非清远电厂真实厂址）
- 场景尺寸：500m × 375m，网格 200 × 150 单元（2m）
- 纹理：2048×1536 JPEG，207 KiB，内嵌于 GLB

## 哪些是量出来的、哪些是算出来的

- **实测**：宏观地形（30m 级 DEM）、影像色彩与地物分布（10m 级）。
- **程序化**：中高频地形细节（幅度 ±1.0m 级，按坡度加权）、
...
- 数据获取时间：2026-09-18T02:22:16+00:00
- 包围盒：{"west": 113.07378393848919, "south": 23.690681830071167, "east": 113.08221606151082, "north": 23.69731816992883}
