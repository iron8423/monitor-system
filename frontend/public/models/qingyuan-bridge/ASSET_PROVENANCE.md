...
本目录的 `qingyuan-bridge.glb` 是「真实地形演示资产」：几何骨架来自公开 DEM，
...
- 演示锚点：23.79560N 113.07550E（清远市区以北约 4km 的模拟选址，非清远电厂真实厂址）
- 场景尺寸：400m × 300m，网格 160 × 120 单元（2m）
- 纹理：2048×1536 JPEG，228 KiB，内嵌于 GLB

## 哪些是量出来的、哪些是算出来的

- **实测**：宏观地形（30m 级 DEM）、影像色彩与地物分布（10m 级）。
- **程序化**：中高频地形细节（幅度 ±1.4m 级，按坡度加权）、
...
- 数据获取时间：2026-09-18T02:22:01+00:00
- 包围盒：{"west": 113.0717712870378, "south": 23.79262045799152, "east": 113.0792287129622, "north": 23.79857954200848}
