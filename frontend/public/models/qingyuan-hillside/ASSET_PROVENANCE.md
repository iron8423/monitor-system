...
本目录的 `qingyuan-hillside.glb` 是「真实地形演示资产」：几何骨架来自公开 DEM，
色彩底来自公开卫星影像，中高频细节为程序化生成。**不是**现场实测成果，
不得用于工程测量、风险评估或应急决策。

## 数据来源

- 高程：Mapzen/AWS terrain tiles（terrarium 编码，SRTM 派生），zoom=15，2 张瓦片。高程数据 SRTM：NASA/USGS 公有领域；瓦片打包：Mapzen Terrain Tiles（CC BY 4.0）。引用：https://registry.opendata.aws/terrain-tiles/
...
- 场景尺寸：320m × 240m，网格 160 × 120 单元（2m）
- 纹理：2048×1536 JPEG，183 KiB，内嵌于 GLB
...
- 数据获取时间：2026-09-18T01:25:18+00:00
- 包围盒：{"west": 113.04799470495553, "south": 23.756751312772924, "east": 113.05466529504446, "north": 23.762168687227078}
